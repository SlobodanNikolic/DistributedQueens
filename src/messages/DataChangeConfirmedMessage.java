...
public class DataChangeConfirmedMessage extends BasicMessage {

	private static final long serialVersionUID = -333251402058492901L;
	
	
	public DataChangeConfirmedMessage(NodeInfo originalSender, NodeInfo sender, NodeInfo receiver) {
		super(MessageType.DATA_CHANGE_CONFIRM, originalSender, sender, receiver);
	}
