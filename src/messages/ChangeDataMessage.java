...
public class ChangeDataMessage extends BasicMessage {

	private static final long serialVersionUID = -333251402058492901L;
	
	
	public ChangeDataMessage(NodeInfo oldData, NodeInfo newData, NodeInfo receiver) {
		super(MessageType.DATA_CHANGE, oldData, newData, receiver);
	}
