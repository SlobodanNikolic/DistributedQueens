...
public class SwitchPlacesMessage extends BasicMessage {

	private static final long serialVersionUID = -333251402058492901L;
	
	
	public SwitchPlacesMessage(NodeInfo originalSender, NodeInfo sender, NodeInfo receiver, String forWho) {
		super(MessageType.SWITCH, originalSender, sender, receiver, forWho);
	}
