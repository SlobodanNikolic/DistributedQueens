...
public class ConnectionBrakeMessage extends BasicMessage {

	private static final long serialVersionUID = -333251402058492901L;
	
	
	public ConnectionBrakeMessage(NodeInfo originalSender, NodeInfo sender, NodeInfo receiver) {
		super(MessageType.CONNECTION_BREAK, originalSender, sender, receiver);
	}
